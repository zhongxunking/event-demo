...
@Component
@Slf4j
public class MyEventFilter2 implements Filter<EventFilterContext> {
    @Override
    ...
    public void doFilter(EventFilterContext context, FilterChain<EventFilterContext> chain) throws Throwable {
        log.info("===========MyEventFilter2-before(在这里可以做一些事件切面相关的工作，比如异步消息、打印日志等)===========");
        chain.doFilter(context);
        log.info("===========MyEventFilter2-after(在这里可以做一些事件切面相关的工作，比如异步消息、打印日志等)===========");
    }
}
